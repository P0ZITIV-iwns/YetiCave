...
$lot_id = $_GET['id'] ?? $_POST['id'] ?? -1;
if (!is_numeric($lot_id) || !ctype_digit(strval($lot_id)))
{
    $lot_id = -1;
}
...
if (!isset($lot_id))
{
    ...
    if (http_response_code() === 404) 
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            } elseif ($price < (empty($lastBet['price']) ? $lot['start_price'] + $lot['step_price'] : $lastBet['price'] + $lot['step_price'])) {
