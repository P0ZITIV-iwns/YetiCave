...
<div class="page-wrapper">
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <?php $hrefname = isset($_SESSION['user_id']) ? "add.php" : "login.php"; ?>
            <a class="main-header__add-lot button" href="<?= $hrefname ?>">Добавить лот</a>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="<?= $hrefname; ?>">Добавить лот</a>
