    ...
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <form class="main-header__search" method="get" action="search.php" autocomplete="off">
                <input type="search" name="search" value="<?=$_GET['search'] ?? ''?>" placeholder="Поиск лота" required>
                <input class="main-header__search-btn" type="submit" name="find" value="Найти">
            </form>
            <?php $style_add = isset($_SESSION['user_id']) ? "visible" : "hidden"; ?>
            <a class="main-header__add-lot button" style="visibility: <?= $style_add; ?>" href="add.php">Добавить лот</a>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" style="visibility: <?= $style_add; ?>" href="add.php">Добавить лот</a>
